"""
Django settings for fifteen_fashions_44405 project.
...
ROOT_URLCONF = 'fifteen_fashions_44405.urls'
...
WSGI_APPLICATION = 'fifteen_fashions_44405.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fifteen_fashions_44405 API",
    "DESCRIPTION": "API documentation for fifteen_fashions_44405 App",
    "VERSION": "v1",
}
